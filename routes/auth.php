...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/librarian', [RegisteredUserController::class, 'createLibrarian'])
        ->name('register.librarian');

    Route::post('register/librarian', [RegisteredUserController::class, 'storeLibrarian'])
        ->name('register.librarian');
