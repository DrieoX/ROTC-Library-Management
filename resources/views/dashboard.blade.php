                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-6">
                        ...
                        <form method="POST" action="{{ route('profile.update') }}" class="mt-4">
                            ...
                            <div class="mb-4">
                                <button type="button" class="button bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md" onclick="toggleModal('dashboardModal')">Update Profile</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <button type="button" class="button bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md" onclick="toggleModal('passwordModal')">Change Password</button>
                    </div>

                    <!-- Dashboard Modal -->
                    <div id="dashboardModal" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        <div class="flex items-center justify-center min-h-screen">
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                                ...
                                <form method="POST" action="{{ route('profile.update') }}" class="mt-4">
                                    ...
                                    <button type="button" class="mt-4 text-gray-600" onclick="toggleModal('dashboardModal')">Close</button>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-center min-h-screen">
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                                ...
                                <form method="POST" action="{{ route('password.update') }}" class="mt-4">
                                    ...
                                    <button type="button" class="mt-4 text-gray-600" onclick="toggleModal('passwordModal')">Close</button>
                                </form>
                            </div>
                        </div>
                    </div>
