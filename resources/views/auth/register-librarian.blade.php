<!-- resources/views/auth/register_librarian.blade.php -->

@extends('layouts.app')

@section('title', 'Register as Librarian')

@section('content')
<div class="container mx-auto mt-8 p-6 max-w-md bg-white text-black rounded-lg shadow-lg">
    <h1 class="text-3xl font-bold mb-6 text-center text-rotc-yellow">Register as Librarian</h1>
    ...
    <form method="POST" action="{{ route('register-librarian') }}">
        ...
        <div class="mb-4">
            <label for="position" class="form-label font-semibold">Position</label>
            <input type="text" name="position" id="position" class="form-input w-full border-gray-300 rounded px-3 py-2" required>
        </div>
